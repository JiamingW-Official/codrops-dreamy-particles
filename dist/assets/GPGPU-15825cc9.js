...
#endif`,Bm="gl_FragColor = linearToOutputTexel( gl_FragColor );",zm=`
...
`+Kv(s.getShaderSource(e),o)}else return i}function Zv(s,e){const t=jv(e);return`vec4 ${s}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Jv(s,e){let t;switch(e){case Cc:t="Linear";break;case Rc:t="Reinhard";break;case Pc:t="Cineon";break;case Bo:t="ACESFilmic";break;case gd:t="AgX";break;case _d:t="Neutral";break;case ip:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Yr=new R;function Qv(){Ge.getLuminanceCoefficients(Yr);const s=Yr.x.toFixed(4),e=Yr.y.toFixed(4),t=Yr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
